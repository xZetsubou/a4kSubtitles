...
def __mock_is_playingvideo(api, mock_state):
    default = api.core.kodi.xbmc.playere().isPlayingVideo
    api.core.kodi.xbmc.playere().isPlayingVideo = lambda: mock_state
    def restore():
        api.core.kodi.xbmc.playere().isPlayingVideo = default
    return restore
